...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="writeSolutionAction.jsp">
				<table class="table table-hover style="">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="Language" name="solutionLanguage" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="What's your solution?" name="solutionContent" maxlength="4096" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
					</table>
